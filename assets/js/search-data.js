...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Research repositories",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-one-paper-has-been-accepted-to-findings-of-emnlp-2026",
          title: 'One paper has been accepted to Findings of EMNLP 2026!',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_Junhyeok_Park.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%65%70%70%69%30%30%31%30%30%34@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/junhyeok-park-609202253", "_blank");
        },
      },{
      id: 'light-theme',
